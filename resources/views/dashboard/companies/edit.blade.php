    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="box box-primary">
                ...
                <form method="POST" action="{{ route('dashboard.users.update', $company->id) }}" enctype="multipart/form-data" >
                    @csrf
                    @method('PUT')
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <img style="width:100px; height:100px;" class=" img-thumbnail img-rounded image-preview-box" src="{{get_image($company->logo)}}" >
                        </div>
                    </div>
